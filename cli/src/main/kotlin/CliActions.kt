...
@OptIn(InternalCoroutinesApi::class) object CliActions {
  ...
  fun createCliActions(defaultIndexer: FileIndexer): Array<Pair<Array<String>, (String) -> Unit>> {
    var indexer: FileIndexer = defaultIndexer
    ...
    actions =
      arrayOf(
        ...
        Pair(arrayOf("list", "watched")) {
          println(indexer.watchedDirectories.joinToString(separator = "\n"))
        },
        Pair(arrayOf("storage")) { arg ->
          run {
            ...
            println("Index rebuilt has been started. " + "Meanwhile you can continue working with a current one")
          }
        },
